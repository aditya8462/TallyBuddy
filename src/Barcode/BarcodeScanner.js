...
import {ServerURL, getData} from '../component/Connection/FetchServices';
import Input from '../component/uicomponents/Input';
...
export default function BarcodeScanner({navigation, route}) {
  ...
  const onSuccess = async id => {
    ...
    if (result.status) {
      // console.log(result);
      setData(result.data);
      navigation.navigate('Barcode Details', {id: id.data});
    }
  };
          ...
          <KeyboardAvoidingView behavior="padding">
            ...
            <RBSheet
              ...
              customStyles={{
                ...
                <View style={{flex:1,height:height*0.5, backgroundColor: theme == 'light' ? 'white' : 'black',}}>
              <FlatList
                data={category}
