...
import {ServerURL, getData, putData,} from '../../Connection/FetchServices';
...
export default function DistributeProduct({navigation, route}) {
...
const handleCreate = async () => {
  ...
  setHideButton(true)
 const result = await putData('product/distribute/' + route.params.id , body);
 if (result.status) {
