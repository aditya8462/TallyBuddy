...
export default function DisplayManufacturingByStore({navigation}) {
  ...
  const fetchProducts = async p => {
    ...
    var result = await getData('manufacturing/bystore/'+st.store_id+'?page='+(p == 'previous'
    ? page.previousPage
    : p == 'next'
    ? page.nextPage
    : page.currentPage),
    ...
    <View style={{alignItems: 'center'}}>
      <View
        ...
        <View
            ...
            {item.added_by ? (
              ...
              {item.manufacturing == '1' ? (
                 ...
                 <View
                   ...
                   <TouchableOpacity
                     onPress={() =>
                       navigation.navigate('AddStockofManufacturingByStore', {
                         id: item.product_id,
                       })
                     }
                     style={{
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('EditManufacturingByStore', {
                id: item.product_id,
              })
            }
            style={{
                ...
                <View style={{marginBottom: height * 0.24}}>
                  <FlatList
                    ...
                    renderItem={({item}) => (
                      <TouchableOpacity
                        onPress={() =>
                          navigation.navigate('Store Manufacturing Detail', {
                            id: item.product_id,
                          })
                        }>
                        <Boxes item={item} />
