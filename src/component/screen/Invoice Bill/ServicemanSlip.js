...
export default function ServicemanSlip({route}) {
  ...
  const fetchDataForBill = async () => {
    setLoader(true);
    const result = await getData('bill/bybill/' + route.params.id);
        ...
        <div>
          ...
          <div class="row">
            <div class="input-field col s6">
              ...
              <div>
                ${billData.mobileno}, ${billData.cemail}
              </div>
            </div>
            <div class="input-field col s6">
              <div>Ship To:-</div>
        ...
        <View style={{height: '90%', justifyContent: 'center'}}>
          <Text>
            <TouchableOpacity style={styles.buttonStyle} onPress={printHTML}>
              <Text>Click to Print BookingSlip</Text>
            </TouchableOpacity>
          </Text>
        </View>
      </View>
