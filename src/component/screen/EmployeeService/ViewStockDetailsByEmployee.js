...
export default function ViewStockDetailsByEmployee({navigation, route}) {
        ...
        <View style={{width: width}}>
          {loader ? (
            ...
            <>
              ...
              <View style={{marginLeft: 20, marginRight: 20, marginTop: height*0.02}}>
                <View
                  style={{
                    justifyContent: 'space-between',
                    flexDirection: 'row',
