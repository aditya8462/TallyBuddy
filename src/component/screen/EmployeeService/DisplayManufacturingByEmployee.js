...
export default function DisplayManufacturingByEmployee({navigation}) {
  ...
  const fetchProducts = async p => {
    setLoader(true);
    var em=await getStoreData('EMPLOYEE')
    var result = await getData('manufacturing/bystore/'+em.store_id+'?page='+ (p == 'previous'
    ? page.previousPage
    : p == 'next'
    ? page.nextPage
    : page.currentPage));;
    ...
    <View style={{alignItems: 'center'}}>
     <View
      ...
      <View
          ...
          {item.added_by ? (
           ...
           {item.manufacturing == '1' ? (
                 ...
                 <View
                   ...
                   <TouchableOpacity
                     onPress={() =>
                       navigation.navigate('AddStockofManufacturingByEmployee', {
                         id: item.product_id,
                       })
                     }
                     style={{
        ...
        <TouchableOpacity
          onPress={() =>
            navigation.navigate('EditManufacturingByEmployee', {id: item.product_id})
          }
          style={{
            width: 30,
            height: 30,
              ...
              {loader ? (
                ...
                <FlatList
                  ...
                  renderItem={({item}) => (
                    <TouchableOpacity
                      onPress={() =>
                        navigation.navigate('Employee Manufacturing Detail', {
                          id: item.product_id,
                        })
                      }>
                      <Boxes item={item} />
