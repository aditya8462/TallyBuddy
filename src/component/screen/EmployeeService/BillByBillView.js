...
export default function BillByBillView({navigation, route}) {
  ...
  const validate = () => {
    ...
    if (!inputs.cancellationreason) {
      handleErrors('Please Input Name', 'cancellationreason');
      isValid = false;
    }
    return isValid;
  };
              ...
              <AppButton
                ...
                onPress={() =>
                  item.status == 1
                    ? handleStatus(2)
                    : item.status == 2
                    ? navigation.navigate('TodayDelivery')
                    : item.status == 3
          ...
          {getLineitems.map(lineitems => (
            <View
              ...
              <View
                ...
                <TouchableOpacity onPress={() => handleImagePress(lineitems.picture)}>
                  <FastImage
                    source={{uri: `${ServerURL}/images/${lineitems.picture}`,priority: FastImage.priority.normal}}
                        ...
                        {viewbill.pictures.map(item => {
                          return (
                            <View style={{marginTop: 10, marginLeft: 5}}>
                               <TouchableOpacity onPress={() => handleImagePress2(item)}>
                              <Image
            ...
            <ScrollView>
              <View>
                <Inputs
                  ...
                  onChangeText={txt =>
                    handleValues(txt.trimStart(), 'cancellationreason')
                  }
                  placeholder="Reason"
                  multiline
            ...
            <ScrollView>
              <View>
                <Input
                  ...
                  onChangeText={txt => handleValues(txt.trimStart(), 'amount')}
