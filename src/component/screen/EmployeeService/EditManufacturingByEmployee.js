...
export default function EditManufacturingByEmployee({navigation, route}) {
  ...
  const handleEdit = async () => {
    ...
    if (validate()) {
      ...
      setHideButton(true)
      const result = await putDataAxios('manufacturing/' + route.params.id, formdata);
          ...
          {loader ? (
            ...
            <View>
              <Text
                ...
                {strings.EDIT_MANUFACTURING_DETAILS}
              </Text>
              <View
                style={{
                  alignItems: 'center',
...
<View style={{marginTop: 5}}>
                ...
                {rawmateriallist.map((item, index) => (
                  <View
                    ...
                    <Picker
                      selectedValue={Number(item.rawmaterialid)}
                      style={{
                        height: 50,
                        width: '60%',
                  ...
                  <View>
                <View style={{marginRight:width*0.55}}>
                <Text style={{color:'red',marginLeft:6}}>{error.rawmaterial}</Text>
                </View>
              </View>
                <Input
                  error={error.mrp}
