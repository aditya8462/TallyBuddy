...
export default function AddProductByEmployee({navigation, route}) {
  ...
  const handleAddInput = () => {
    ...
    newInputs.push({productname: '', qty: '', costPrice: '', mrp: ''});
  ...
  const handleSubmit = async () => {
    ...
    if (validate()) {
      ...
      formdata.append('pstock', inputs.pstock);
      ...
      formdata.append('added_by', employeeAdmin.name);

      formdata.append('storeid', employeeAdmin.store_id);
