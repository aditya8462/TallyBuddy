...
export default function EmployeeReportSettlementDetails({navigation,route}) {
  ...
  const handleSettlement=()=>{
    navigation.navigate('ReportByEmployee',{
      id: route.params.id,
    })
  }
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Tag
                  bgColor={item.isVerified == '1' ? COLORS.green : '#ffff'}
                  tagText={item.isVerified == '1' ? 'Verified' : 'Not Verified'}
                  txtColor={item.isVerified == '1' ?  '#03753C': 'red' }
                  tagWidth={130}
                />
              </View>
            </View>
  ...
  return (
    ...
    <ScrollView>
      <View style={{flex: 1}}>
        ...
        <View style={{width:width*0.9,justifyContent:'center',marginLeft:width*0.05}}>
        <AppButton buttonText={strings.PAY} btnWidth={0.2} onPress={handleSettlement}/> 
        </View>
