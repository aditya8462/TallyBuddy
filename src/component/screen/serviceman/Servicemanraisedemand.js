...
import EmployeImageSet from '../SettingEmployeImage/EmployeImageSet';
const {width, height} = Dimensions.get('window');

export default function Servicemanraisedemand({navigation, route}) {
  ...
  const handleSubmit = async () => {
    var employees = await getStoreData('SERVICEMAN');
    if(validate()){
    var body = {
      ...
      tostoreid: storelist,
      fromservicemanid: employee.serviceman_id,
