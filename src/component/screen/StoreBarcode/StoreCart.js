...
export default function StoreCart({navigation}) {
  ...
  const handleClick = () => {
    navigation.navigate('StoreBarcodeScan');
  };

  const handleForward = () => {
    navigation.navigate('StoreInvoice');
  };
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text style={{fontFamily: 'Poppins-Medium', fontSize: 12, color: theme == 'light' ? '#2C2C2C' : 'white',}}>
                  {strings.CATEGORY}:
                </Text>
                <Text
                  adjustsFontSizeToFit
              ...
              <View
                ...
                <FA
                  name="rupee"
                  size={12}
                  style={{ color: theme == 'light' ? 'black' : 'red', padding: 1, marginLeft: 5}}
                />
                <Text
                  numberOfLines={1}
                  adjustsFontSizeToFit
