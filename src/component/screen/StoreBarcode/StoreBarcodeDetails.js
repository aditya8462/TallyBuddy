...
export default function StoreBarcodeDetails({navigation, route}) {
  ...
  // var priceData = inputs.costprice
  // const [offerPrice, setOfferPrice] = useState(priceData);
  console.log(cpp);
  return (
    <ImageBackground
